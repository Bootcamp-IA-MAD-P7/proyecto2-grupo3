import { CalendarClock, Pencil, Play, Save, Trash2, X } from "lucide-react";
...
export default function Reservas({
  ...
  const isReservaActiva = (fechaHora: string) => {
    ...
    return ahora >= inicio + 60 * 1000 && ahora < inicio + 60 * 60 * 1000;
  };
            ...
            <form onSubmit={handleSubmitModal} className="p-6 flex flex-col gap-5">
              ...
              <div className="flex items-center justify-end gap-3 mt-2 pt-4 border-t border-slate-100">
                ...
                >
                  ...
                  {isCreating ? "CREANDO..." : editingData ? "ACTUALIZAR RESERVA" : "CREAR RESERVA"}
                </button>
              </div>
            </form>
          </div>
